...
class Classifier(ABC):
    ...
    def train_update(
        ...
        current_run : wandb.sdk.wandb_run.Run
            The wandb run to load the model from if model is not already loaded
        """
        pass
    ...
    @abstractmethod
    def save(self, current_run: wandb.sdk.wandb_run.Run):
        """Save the classifier, using the run ID

        Parameters
        ----------
        current_run : wandb.sdk.wandb_run.Run
            The wandb run to save the model to
        """
        pass
...
class GPT2Classifier(Classifier):
    ...
    def _load_model(self, current_run: wandb.sdk.wandb_run.Run):
        ...
        ----------
        current_run : wandb.sdk.wandb_run.Run
            The wandb run to load the model from
        """
